<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<% // 이 구문을 스크립틀릿이라고 해서 HTML 문서 내에 JAVA
//코드를 기술할 수 있는 영역 // 현재 이 jsp에서 필요로 하는 데이터들 -> request/
//객체의 attribute 영역에 (key-value 세트로) 담겨있음 // Object 타입은 모든타입의 //최상위 부모이기 때문에 "강제형변환"해서 변수에 담으면 됨 // 주의)다형성에 의해 //잘못 DownCasting 하면 ClassCastException 발생
